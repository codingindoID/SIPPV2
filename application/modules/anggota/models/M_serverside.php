...
class M_serverside extends CI_Model
{
    ...
    var $column_order     = ['', 'nama', 'tb_anggota.id_pangkalan', 'tb_anggota.id_gudep', 'golongan', 'ta', ''];
    var $column_search     = ['nama', 'tb_anggota.id_pangkalan', 'tb_anggota.id_gudep', 'golongan', 'ta'];
    var $order             = ['nama' => 'asc'];
